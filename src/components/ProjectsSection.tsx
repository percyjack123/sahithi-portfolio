...
const projects = [
  {
    title: "MentorX",
    description: "AI-powered mentor-mentee platform with quad-role auth, student risk scoring, and 50+ REST endpoints.",
    tech: ["React", "Node.js", "Express", "PostgreSQL", "JWT"],
    github: "https://github.com/percyjack123/mentorx",
    badge: null,
    color: "cyan" as const,
  },
  {
    title: "BailWatch",
    description: "Judicial bias audit system that detects disparities in bail decisions across income, location, and social group.",
    tech: ["Spring Boot", "React", "PostgreSQL", "Gemini AI", "Docker"],
    github: "https://github.com/percyjack123/BailWatch",
    badge: null,
    color: "purple" as const,
  },
  {
    title: "Resume Roaster",
    description: "Uploads your resume, extracts text via PDFBox, and gets it brutally scored by Gemini AI.",
    tech: ["Spring Boot", "React", "Gemini AI", "PDFBox"],
    github: "https://github.com/percyjack123/resume-roaster",
    badge: null,
    color: "pink" as const,
  },
  {
    title: "TrueMed",
    description: "Medicine counterfeit detection system with a Flask API integrating ML model inference.",
    tech: ["Flask", "React", "Tailwind CSS", "ML Integration"],
    github: "https://github.com/percyjack123/TrueMed",
    badge: null,
    color: "cyan" as const,
  },
  {
    title: "PortGenie",
    description: "AI-assisted portfolio generator with JWT auth, CRUD APIs, and MongoDB persistence.",
    tech: ["Node.js", "Express", "MongoDB", "JWT"],
    github: "https://github.com/percyjack123/Portgenie",
    badge: null,
    color: "purple" as const,
  },
];
